        ...
        <div className={classes["pageContentDiv"]}>
          <div className={classes["aboutUsTextDiv"]}>
            <p className={classes["aboutUsText"]}>
              ...
              Dezembro de 2008 pelo grupo de media escandinavo Schibsted, e que
              resulta da conversão para o mercado português do site de
              classificados sueco, Blocket.se. Graças ao enorme sucesso do
              Blocket na Suécia, a Schibsted decidiu internacionalizar este
              conceito, lançando sites de classificados em vários mercados, como
              em <a href="www.espanha.pt">Espanha</a> (2005),{" "}
            ...
            <p className={classes["aboutUsText"]}>
              ...
              essa missão em mente que a nossa equipa trabalha, desde o Porto,
              todos os dias.
            </p>
          </div>
          ...
          <div className={classes["aboutUsTextDiv"]}>
            <p className={classes["aboutUsText"]}>
              ...
              <a href="custojusto.pt">comprar e vender</a> uma grande variedade
              de coisas. Aqui poderá conseguir um custo justo para o que quer
              comprar, e obter preços justos para o que quer vender.
            </p>

            <p className={classes["aboutUsText"]}>
              O CustoJusto.pt proporciona-lhe uma forma simples, rápida e fácil
              de vender, em qualquer dia da semana, a qualquer hora, esteja onde
            ...
            <p className={classes["aboutUsText"]}>
              ...
              compradores, sem qualquer interferência no processo de negociação
              entre ambas as partes - o negócio é realizado directamente entre o
              comprador e o vendedor, sem comissões ou pagamento de valores pela
              introdução de anúncios: CustoJusto.pt - Justamente o que
              procurava!
            </p>
          </div>
