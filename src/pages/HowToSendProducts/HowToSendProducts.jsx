...
function HowToSendProducts() {
  return (
    <HelpPage>
      <h2 className={classes["caresMainTitle"]}>Envio de produtos</h2>
      ...
      <ul className={classes["caresList"]}>
        ...
        <li className={classes["caresItem"]}>
          <p className={classes["caresItemText"]}>
            Os fraudulentos prontificam-se a apresentar documentação (Bilhete de
            Identidade, passaporte, etc) como garantia. Isto não o protege da
            fraude!
          </p>
        </li>
        ...
        <li className={classes["caresItem"]}>
          <p className={classes["caresItemText"]}>
            ...
            garante que seja livre de risco. Não tem como ver o produto antes de
            o pagar.
          </p>
        </li>
      </ul>
      ...
      <ul className={classes["caresList"]}>
        ...
        <li className={classes["caresItem"]}>
          <p className={classes["caresItemText"]}>
            ...
            Nunca utilize serviços de pagamento como o Western Union, Money Gram
            ou Bidpay, uma vez que são difíceis de controlar ou cancelar o
            pagamento. Estes serviços são muito populares entre as pessoas que
            praticam fraudes por essas mesmas razões.
          </p>
        </li>
      </ul>
    </HelpPage>
