      ...
      <ul className={classes["caresList"]}>
        ...
        <li className={classes["caresItem"]}>
          <p className={classes["caresItemText"]}>
            Nunca compre algo sem que saiba bastante informação sobre o produto
            e vendedor.
          </p>
        </li>
        ...
        <li className={classes["caresItem"]}>
          <p className={classes["caresItemText"]}>
            Tome precauções especiais quando a oferta parece ser boa demais para
            ser verdade.
          </p>
        </li>
        <li className={classes["caresItem"]}>
        ...
        <li className={classes["caresItem"]}>
          <p className={classes["caresItemText"]}>
            Mesmo quando o vendedor lhe apresenta informação pessoal ou o número
            da conta bancária, isso não o protege de ser enganado.
          </p>
        </li>
        <li className={classes["caresItem"]}>
          <p className={classes["caresItemText"]}>
            Sempre que possível, solicite a factura/recibo original do produto e
            um recibo da compra.
          </p>
        </li>
        <li className={classes["caresItem"]}>
